...
docx_template = DocxTemplate('nysMonthlyReportPlantilla.docx')

# memfile = bytes_to_str()
# events = sys.stdout.write(sys.argv[1])
# data = sys.stdout.write(sys.argv[2])
# print("fsijdaks")
# sys.stdout.flush()
...
docx_template.save("./excels/NewReport.docx")
